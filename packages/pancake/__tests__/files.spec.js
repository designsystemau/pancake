...
const modulePath = Path.normalize(
	`${__dirname}/../../../tests/test5/node_modules/@gov.au`
);

const result = [
	Path.normalize(
		`${__dirname}/../../../tests/test5/node_modules/@gov.au/pancake`
	),
	Path.normalize(
		`${__dirname}/../../../tests/test5/node_modules/@gov.au/pancake-js`
	),
	Path.normalize(
		`${__dirname}/../../../tests/test5/node_modules/@gov.au/pancake-sass`
	),
	Path.normalize(
		`${__dirname}/../../../tests/test5/node_modules/@gov.au/testmodule1`
	),
	Path.normalize(
		`${__dirname}/../../../tests/test5/node_modules/@gov.au/testmodule2`
	),
	Path.normalize(
		`${__dirname}/../../../tests/test5/node_modules/@gov.au/testmodule3`
	),
];
...
const location = Path.normalize(
	`${__dirname}/../../../tests/test2/package.json`
);
