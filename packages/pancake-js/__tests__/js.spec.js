...
const file = Path.normalize(
	`${__dirname}/../../../tests/test2/node_modules/@gov.au/testmodule2/lib/js/module.js`
);
...
const from = Path.normalize(
	`${__dirname}/../../../tests/test2/node_modules/@gov.au/testmodule1/lib/js/module.js`
);
const settings = {
	minified: true,
	modules: true,
...
const to = Path.normalize(
	`${__dirname}/../../../tests/test2/pancake/js/testmodule1.js`
);
const tag = '@gov.au/testmodule1 v11.0.1';
const result =
	'/*! @gov.au/testmodule1 v11.0.1 */confirm("testmodule1:v11.0.1");';
